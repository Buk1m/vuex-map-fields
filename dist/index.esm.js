...
var mapFieldsDynamically = function mapFieldsDynamically(namespace, fields, getterType, mutationType) {
  var fieldsObject = Array.isArray(fields) ? arrayToObject(fields) : fields;
  return Object.keys(fieldsObject).reduce(function (prev, key) {
    var path = fieldsObject[key];
    var field = {
      get: function get() {
        var moduleName = namespace.bind(this)();

        if (moduleName.length && moduleName.charAt(moduleName.length - 1) !== "/") {
          moduleName += "/";
        }

        var getterName = "".concat(moduleName).concat(getterType || "getField");
      ...
      set: function set(value) {
        ...
        var mutationName = "".concat(moduleName).concat(mutationType || "updateField");
...
export { createHelpers, getField, mapFields, mapFieldsDynamically, mapMultiRowFields, updateField };
